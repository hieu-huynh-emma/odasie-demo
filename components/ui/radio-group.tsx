  ...
  return (
    <AriaRadioGroup
      className={composeRenderProps(className, (className, renderProps) =>
        cn(
          'group/radiogroup flex flex-col flex-wrap justify-between gap-2',
    ...
    <AriaRadio
      ...
      {composeRenderProps(children, (children, renderProps) => (
        <>
          <span
            className={cn(
              'jolly-Radio border-primary ring-offset-background flex aspect-square size-4 items-center justify-center rounded-full border text-primary-500',
              /* Focus */
              'group-data-[focused]/radio:outline-none',
              /* Focus Visible */
              'group-data-[focus-visible]/radio:ring-ring group-data-[focus-visible]/radio:ring-2 group-data-[focus-visible]/radio:ring-offset-2',
              /* Disabled */
