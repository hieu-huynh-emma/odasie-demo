  ...
  <AriaCheckbox
    ...
    {composeRenderProps(children, (children, renderProps) => (
      <>
        <div
          className={cn(
            'ring-offset-background flex size-4 shrink-0 items-center justify-center rounded-[4px] border-2 border-yellow-500 text-current text-primary-600',
            /* Focus Visible */
            ...
            /* Selected */
            'group-data-[indeterminate]/checkbox:bg-primary group-data-[selected]/checkbox:bg-primary group-data-[indeterminate]/checkbox:text-primary-foreground group-data-[selected]/checkbox:text-primary-foreground group-data-[selected]/checkbox:border-primary-500',
            /* Disabled */
